		                			...
		                			<form  class="aj-form"  method="post">
		                				...
		                				<div class="form-body">
		                					...
		                					<div class="row">
											    <div class="col-md-6">
											        <div class="form-group">
											            ...
											            <input type="text" name="name" id="name" class="form-control" value="<?php echo !empty($products[0]->name) ?  $products[0]->name : ' '?>">
											        </div>
											    </div>
											    <div class="col-md-6">
											        <div class="form-group">
											            <label class="control-label">Price</label>
											            <input type="text" name="price" id="price" class="form-control" value="<?php echo !empty($products[0]->price) ?  $products[0]->price : ' '?>">
											        ...
											        <div class="form-group">
			                							...
			                							<select id='project-select' class="custom-select" name="tax">
												            ...
												            <?php foreach($tax as $row) { 
												            	$str = '';
												            	if($row->rate == $products[0]->tax){
												            		$str = 'selected';
												            	}
															echo '<option value="'.$row->rate.'" '.$str.'>'.$row->taxname.'('.$row->rate.'%)</option>';
																}
													 		?>
												        </select> 
											        </div>
											    ...
											    <div class="col-md-6">
											        <div class="form-group">
											            ...
											            <textarea id="" class="form-control" name="description" rows="4"><?php echo !empty($products[0]->description) ?  $products[0]->description : ' '?></textarea>
											        </div>
											    </div>
											</div>
			                                ...
			                                <div class="form-actions">
				                                <input type="submit" id="save-form" class="btn btn-success" value="Update"><i class="fa fa-check"></i> 
